...
/// How much of a tool call's argument and result text a rendered transcript keeps
/// per entry. Enough to see what a call did and what came back; not so much that
